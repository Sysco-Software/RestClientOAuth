codeunit 50327 DeviceCodeFlowImplKFM
{
    Access = Internal;
    ...
    local procedure AcquireTokenByDeviceCode(OAuthClientApplication: Codeunit "OAuth Application Config KFM")
    var
        OAuthPublicClient: Codeunit "OAuth Public Client KFM";
        DeviceCodeAuthorization: Page "Device Code Authorization KFM";
