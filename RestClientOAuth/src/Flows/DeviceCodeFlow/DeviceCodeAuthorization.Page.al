page 50312 "Device Code Authorization KFM"
{
    ...
    layout
    {
        area(Content)
        {
            ...
            usercontrol(DeviceCodePollingTimer; "Device Code Polling Timer KFM")
            {
                ApplicationArea = All;
    ...
    var
        ...
        OAuthPublicClient: Codeunit "OAuth Public Client KFM";
    ...
    internal procedure SetDeviceAuthorization(DeviceCodeValue: SecretText; UserCodeValue: Text; VerificationUriValue: Text; MessageText: Text; ExpiresInValue: Integer; PollIntervalValue: Integer; Authority: Interface "OAuth Authority KFM"; ClientApplication: Codeunit "OAuth Application Config KFM")
    begin
    ...
    internal procedure GetAuthenticationResult() ReturnValue: Codeunit "OAuth AuthenticationResult KFM"
    begin
