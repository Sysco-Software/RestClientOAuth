codeunit 50505 "BC Connector Device Code Flow"
{
    ...
    begin
        ...
        OAuthAuthorizationFlow := CreateDeviceCodeGrantFlow(OAuthAuthority);
    ...
    begin
        // MicrosoftEntraID.SetTenantID('<YOUR_TENANT_ID>');
        OAuthAuthority := MicrosoftEntraID;
    end;

    local procedure CreateDeviceCodeGrantFlow(OAuthAuthority: Interface "OAuth Authority KFM") OAuthAuthorizationFlow: Interface "OAuth Authorization Flow KFM"
    var
